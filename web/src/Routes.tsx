...
import EasePageLayout from './layouts/EasePageLayout/EasePageLayout'
...
const Routes = () => {
  return (
    <Router>
      ...
      <Set wrap={EasePageLayout}>
        <Route path="/pinned" page={PinnedPage} name="pinnedPage" />
        <Route path="/wordCloud" page={WordCloudPage} name="wordCloudPage" />
        ...
        <Route path="/viewVoiceEntry/{id:Int}" page={ViewVoiceEntryPage} name="viewVoiceEntry" />
        <Route path="/viewTextEntry/{id:Int}" page={ViewTextEntryPage} name="viewTextEntry" />
